...
初版(ツール 15)を、並列エージェント 3 波 + 各実装への独立レビューで **ツール 81 + prompts 8 + resources 8** に拡張した。
...
- [x] 周辺フレームワーク 18+ — BIZBOK / Zachman / C4 / Wardley / IT4IT / DDD 等との棲み分けと併用方法
...
- [x] 検証 — vitest 76 件 / スモークテスト 90 チェック
